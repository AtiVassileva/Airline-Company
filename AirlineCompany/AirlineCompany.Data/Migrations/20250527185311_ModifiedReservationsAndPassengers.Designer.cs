...
namespace AirlineCompany.Web.Data.Migrations
{
    ...
    [Migration("20250527185311_ModifiedReservationsAndPassengers")]
    partial class ModifiedReservationsAndPassengers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AirlineCompany.Models.Passenger", b =>
                {
                    b.HasOne("AirlineCompany.Models.Reservation", "Reservation")
                        .WithOne("Passenger")
                        .HasForeignKey("AirlineCompany.Models.Passenger", "ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
