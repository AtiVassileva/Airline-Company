...
IF OBJECT_ID('21180083.ActivityLogs', 'U') IS NULL
BEGIN
    EXEC('
    CREATE TABLE [21180083].[ActivityLogs] (
...
DECLARE @schemaName SYSNAME = '21180083';
...
BEGIN
    ...
    IF @act IS NOT NULL
    BEGIN
        INSERT INTO [21180083].[ActivityLogs] (Id, Action, Timestamp, TableName)
